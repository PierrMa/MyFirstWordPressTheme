...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header pmf-entry-header">
		...
		if ( 'post' === get_post_type() ) :
			?>
			<div class="entry-meta pmf-entry-meta">				
				...
				<?php 
					$amountOfComment = get_comments_number(get_the_ID());
					if($amountOfComment):
						echo $amountOfComment;
					else:?>
